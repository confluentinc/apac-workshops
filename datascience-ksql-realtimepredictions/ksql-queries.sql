...
CREATE TABLE cardholders (
  ...
  fico_score BIGINT,
  age BIGINT)
WITH (KAFKA_TOPIC='fraud-demo.public.cardholders', value_format='AVRO');
...
CREATE TABLE merchants (
  ...
  latitude DOUBLE,
  longitude DOUBLE)
WITH (KAFKA_TOPIC='fraud-demo.public.merchants', value_format='AVRO');
...
WITH (KAFKA_TOPIC='fraud-demo.public.transactions', value_format='AVRO');
